...
variable "ebs_root_name_tag" {
  default = "Polygon_Edge_Root_EBS_Volume_TestNet"
  type = string
  description = "The name tag for the Polygon Edge instance root volume. Default: Polygon_Edge_Root_EBS_Volume_TestNet"
}

variable "instance_name" {
  default = "Polygon_Edge_Instance_TestNet"
  type = string
...
variable "instance_interface_name_tag" {
  default = "Polygon_Edge_Instance_Interface_TestNet"
  type = string
  description = "The name of the instance interface. Default: Polygon_Edge_Instance_Interface_TestNet"
}
...
variable "chain_data_ebs_name_tag" {
  default = "Polygon_Edge_chain_data_ebs_volume_TestNet"
  type = string
  description = "The name of the chain data EBS volume. Default: Polygon_Edge_chain_data_ebs_volume_TestNet"
}
